    ...
    return(
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" >
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="208" height="240">
          <path fill="#bdc3c7" d="M56.29165124598851 0L112.58330249197702 32.5L112.58330249197702 97.5L56.29165124598851 130L0 97.5L0 32.5Z">
          </path>
        </svg>
        <svg x={13.5} y={14} style={{ overflow: "visible" }}>
          ...
          <path
            id="path-standard"
            ref={el => {this.ref = el}}
            stroke={pctl <= .35 ? "url(#cls-low)" : "url(#cls-standard)"}
            fillOpacity="0"
            strokeDashoffset={pctl === 1 ? "100" : ""}
            strokeDasharray={pctl === 1 ? "" : "300 300"}
            strokeWidth="24"
